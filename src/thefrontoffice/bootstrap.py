...
from thefrontoffice.domain.ports import AnalysisModel, CompetitionProvider, TradeProvider
...
def _build_nba() -> CompetitionProvider:
    ...
    from thefrontoffice.adapters.outbound.platforms.yahoo import client as yahoo
